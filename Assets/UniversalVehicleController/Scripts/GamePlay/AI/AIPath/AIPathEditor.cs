...
namespace PG
{
    ...
    public class AIPathEditor :Editor
    {
        ...
        public override void OnInspectorGUI ()
        {
            ...
            if (GUILayout.Button ("Reset speed limits"))
            {
                ResetSpeedlimit ();
            }
        ...
        /// <summary>
        /// Reset speed limit for all points.
        /// </summary>
        void ResetSpeedlimit ()
        {
            for (int i = 0; i < AIPath.Waypoints.Count; i++)
            {
                var waypoint = AIPath.Waypoints[i];
                waypoint.SpeedLimit = AIPath.MaxSpeedLimit;
                AIPath.Waypoints[i] = waypoint;
            }
